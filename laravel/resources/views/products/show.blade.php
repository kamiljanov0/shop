...
<!-- Products Start -->
    ...
    <div class="container-fluid pb-5">
        <div class="row px-xl-5">
                ...
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner bg-light">
                        <div class="carousel-item active">
                            <img class="w-100 h-100" src="{{'/storage/'.$product->photo_one}}" alt="Image">
                        </div>
                        @if($product->photo_two != null)
                        <div class="carousel-item">
                            <img class="w-100 h-100" src="{{'/storage/'.$product->photo_two}}" alt="Image">
                        </div>
                        @endif
                        @if($product->photo_three != null)
                        <div class="carousel-item">
                            <img class="w-100 h-100" src="{{'/storage/'.$product->photo_three}}" alt="Image">
                        </div>
                        @endif
                            @if($product->photo_four != null)
                        <div class="carousel-item">
                            <img class="w-100 h-100" src="{{'/storage/'.$product->photo_four}}" alt="Image">
                        </div>
                        @endif
                    </div>
            ...
            <div class="col-lg-4 float-left h-auto mb-30">
            ...
            <div class="col-lg-3 bg-white  float-right h-auto  mb-30">

                    <ul class="h5 mt-5">
                        @foreach($product_items as $item)
                            @if($item->television!= null)
                             <li><span style="">{{$item->television['smart']}}</li>
            ...
            <div class="col">
                <div class="bg-light p-30">
                    <div class="nav nav-tabs mb-4">
                        <a class="nav-item nav-link text-dark active" data-toggle="tab" href="#tab-pane-1">Tavsif</a>
                ...
                <div class="owl-carousel related-carousel">
                    ...
                    <div class="product-item bg-light">
                        <div class="product-img position-relative overflow-hidden">
                            <img class="img-fluid w-100" src="{{'/storage/'.$recent_product->photo_one}}" alt="">
