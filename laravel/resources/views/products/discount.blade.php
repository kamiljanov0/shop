                ...
                <div class="row pb-3">
                    <div class="col-12 pb-1">
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            <div class="ml-2">
                                    <div class="btn-group">
                                        <button type="button" class="btn btn-sm btn-light dropdown-toggle" data-toggle="dropdown">Saralash</button>
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <button type="submit" class="dropdown-item" name="sort" value="latest">Oxirgi</button>
                                            <button type="submit" class="dropdown-item" name="sort" value="cheapest">Arzon</button>
                                            <button type="submit" class="dropdown-item" name="sort" value="expensive">Qimmat</button>
                                        </div>
                                    </div>
                              </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-5 col-sm-12 pb-sm-1">
                            <div class="product-item bg-light ">
                                ...
                                <div class="text-center py-4">
                                    ...
                                    <br>
                                    <h5 class="text-red"><span class="text-danger"> {{$product->discount}} UZS</span><img width="30" height="30" src="https://img.icons8.com/ios/50/discount--v1.png" alt="discount--v1"/></h5><h6 class="text-muted ml-2"><del>Narxi:{{$product->price}} UZS</del></h6>
                                    <br><br>
                                    ...
                                    <div class="d-flex align-items-center justify-content-center mt-2">
                                        ...
                                        <!--<h6 class="text-muted ml-2"><del>12322</del></h6> -->
                                    </div>
