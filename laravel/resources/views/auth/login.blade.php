            ...
            <div class="panel border bg-white">
                ...
                <div class="panel-body p-3">
                    <form action="{{route('authenticate')}}" method="POST">
                        ...
                        <div class="form-inline"> <input type="checkbox" name="remember" id="remember"> <label for="remember" class="text-muted">Remember me</label> <a href="#" id="forgot" class="font-weight-bold">Parol esingizdan chiqdimi</a> </div>
                        <button type="submit" class="btn btn-warning btn-block mt-3">Kirish</button>
                        <div class="text-center pt-4 text-muted">Ro'yaxatdan o'tmaganmisiz <a href="{{route('register')}}">Ro'yxatdan o'tish</a> </div>
                    </form>
                </div>
