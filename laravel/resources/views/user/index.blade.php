        ...
        <div class="row px-xl-5">
            ...
            <div class="col-lg-4 mr-5   col-md-8">
                ...
                <div class="bg-dark" style="border-radius: 10px">
                    <h4 class="text-primary ml-3 " >Ism: {{auth()->user()->name}}</h4>
                    <h4 class="text-primary ml-3">Familiya:  {{auth()->user()->last_name}}</h4>
                    <h4 class="text-primary ml-3">Email:  {{auth()->user()->email}}</h4>
                    <h4 class="text-primary ml-3">Parol:  **********</h4>
                    <a class="btn btn-danger float-right" href="">O'zgartirish</a>
                </div>
            </div>
